...
class CheckpointIO(object):
    ...
    def load_file(self, filename):
        ...
        if os.path.exists(filename):
            ...
            # Load with map_location to avoid errors when checkpoint was saved
            # on a different CUDA ordinal. Map to available CUDA device or CPU.
            ...
            # Fix: use FileNotFoundError instead of FileExistsError
